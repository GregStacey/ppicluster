...
ggplot(df.change, aes(x=noise, y=n.clusters, color=algorithm)) + geom_line() +
  ...
  theme_bw()
fn = "/Users/gregstacey/Academics/Foster/Manuscripts/ClusterExplore/figures/fig_sup3E1_v01.png"
...
fn = "/Users/gregstacey/Academics/Foster/Manuscripts/ClusterExplore/figures/fig_sup3E2_v01.png"
